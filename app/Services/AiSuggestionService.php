...
class AiSuggestionService
{
    ...
    public function suggest(Request $request): JsonResponse
    {
        ...
        try {
            ...
            if ($e instanceof \RuntimeException && str_contains($e->getMessage(), 'GROQ_API_KEY')) {
                Log::warning('AI suggestions unavailable', $context);
            } else {
                Log::error('AI suggestions failed', $context);
            }
