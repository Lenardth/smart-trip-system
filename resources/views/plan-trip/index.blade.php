...
<div class="planner-wrap">
    ...
    <div class="planner-card" id="step3">
        ...
        <div class="btn-row">
            ...
            <button class="primary-button" onclick="generateSuggestions()">
    ...
    <div id="step4" style="display:none;">
        ...
        <div class="btn-row">
            ...
            <button class="pdf-button" id="receiptBtn" onclick="openReceipt()"><i class="fas fa-receipt"></i> View &amp; Print Receipt</button>
