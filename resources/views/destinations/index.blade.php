...
@push('styles')
    @vite(['resources/css/blade/destinations/index.css'])
@endpush

@push('scripts_body')
    @vite(['resources/js/blade/destinations/index.js'])
@endpush
...
<div class="dest-wrap">
    ...
    <div class="dest-grid">
        <div class="dest-card">
            <div class="dest-card-img" style="background-image:url('https://images.unsplash.com/photo-1516483638261-f4dbaf036963');">
                <span class="card-badge">Popular</span>
                <span class="card-rating"><i class="fas fa-star"></i> 4.8</span>
            </div>
            <div class="dest-card-body">
                ...
                <div class="dest-tags">
                    ...
                    <span class="dest-tag">Spiritual</span>
                    <span class="dest-tag">Relaxation</span>
                </div>
                ...
                <div class="dest-card-footer">
                    <div class="dest-price">$1,200 <span>/ person</span></div>
                    <button class="primary-button" style="padding:9px 18px;font-size:13px;">View Details</button>
                </div>
            </div>
        </div>
        <div class="dest-card">
            <div class="dest-card-img" style="background-image:url('https://images.unsplash.com/photo-1511739001486-6bfe10ce785f');">
            ...
            <div class="dest-card-body">
                ...
                <div class="dest-tags">
                    ...
                    <span class="dest-tag">Temples</span>
                ...
                <div class="dest-card-footer">
                    <div class="dest-price">$2,100 <span>/ person</span></div>
                    <button class="primary-button" style="padding:9px 18px;font-size:13px;">View Details</button>
                </div>
            </div>
        </div>
        <div class="dest-card">
            <div class="dest-card-img" style="background-image:url('https://images.unsplash.com/photo-1579530190412-b35a65e17c8d');">
            ...
            <div class="dest-card-body">
                ...
                <div class="dest-card-footer">
                    <div class="dest-price">$2,800 <span>/ person</span></div>
                    <button class="primary-button" style="padding:9px 18px;font-size:13px;">View Details</button>
                </div>
            </div>
        </div>
        <div class="dest-card">
            <div class="dest-card-img" style="background-image:url('https://images.unsplash.com/photo-1578662996442-48f60103fc96');">
            ...
            <div class="dest-card-body">
                ...
                <div class="dest-tags">
                    ...
                    <span class="dest-tag">Sunset</span>
                    <span class="dest-tag">Island</span>
                </div>
                ...
                <div class="dest-card-footer">
                    <div class="dest-price">$1,800 <span>/ person</span></div>
                    <button class="primary-button" style="padding:9px 18px;font-size:13px;">View Details</button>
                </div>
            </div>
        </div>
        <div class="dest-card">
            <div class="dest-card-img" style="background-image:url('https://images.unsplash.com/photo-1477959858617-67f85cf4f1df');">
                <span class="card-rating"><i class="fas fa-star"></i> 4.6</span>
            </div>
            <div class="dest-card-body">
                <h3>Paris, France</h3>
                <div class="dest-location"><i class="fas fa-map-marker-alt"></i> Western Europe</div>
                <div class="dest-tags">
                    ...
                    <span class="dest-tag">Cuisine</span>
                    <span class="dest-tag">Fashion</span>
                </div>
                ...
                <div class="dest-card-footer">
                    <div class="dest-price">$2,400 <span>/ person</span></div>
                    <button class="primary-button" style="padding:9px 18px;font-size:13px;">View Details</button>
                </div>
            </div>
        </div>
        <div class="dest-card">
            <div class="dest-card-img" style="background-image:url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4');">
            ...
            <div class="dest-card-body">
                ...
                <div class="dest-card-footer">
                    <div class="dest-price">$3,000 <span>/ person</span></div>
                    <button class="primary-button" style="padding:9px 18px;font-size:13px;">View Details</button>
                </div>
            </div>
        </div>
